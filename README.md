_The repository contains the reference tutorials for Google Vertex AI with GenAI, OpenAI, LLM, Machine learning and different use-case scenarios. Its a reference purpose only_
